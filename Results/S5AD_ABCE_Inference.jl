#=
    S5AD - Synthetic data  with intermediate r (relative to K)
...
Random.seed!(1)
@time P, p_accept, ε_seq  = abc_smc_εtarget(dist,prior,maxsteps=20,n=2000,α=0.75,εtarget=12.925497591055318);

##############################################################
## 5 - Save results
##############################################################

@save "Results/Files_syn/S5AD_ABCE_inference.jld2" P p_accept ε_seq
