#=
    SP5_lesq - Synthetic data with intermediate r (relative to K) - KNOWN SYNTHETIC CONTROL DATA
...
@save "Results/Files_syn/Lesq_SP5.jld2" Tplot xopt θfixed median_data_syn