#=
    OPTD_intr_1A - Synthetic data for optimal experimental design study with intermediate r (relative to K)
...
prior_observed = Product([
    Truncated(Normal(3.86125e-7,3.86125e-7/100),0,Inf), # μr
    Truncated(Normal(4.56962e-7,4.56962e-7/100),0,Inf), # σr
...
@save filepath_save * "OPTD_intr_1A.jld2" observed_data_J  θobserved_J
