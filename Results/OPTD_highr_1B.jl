#=
    OPTD_highr_1B - Synthetic data for optimal experimental design study with high r (relative to K)
...
@load filepath_save * "OPTD_highr_1A.jld2" observed_data_J
...
# N=100; # number of data sets per time point (for this HPC loop)
...
@save filepath_save * "OPTD_highr_1B_" * "θsim_save" * "_seed_" * string(HPC_loop_id)  * ".jld2" θsim_save
@save filepath_save * "OPTD_highr_1B_" * "discrepancy" * "_seed_" * string(HPC_loop_id)  * ".jld2" discrepancy
