#=
    S9CV - Synthetic data  with high r (relative to K)
...
Random.seed!(1)
@time P, p_accept, ε_seq  = abc_smc_εtarget(dist,prior,maxsteps=20,n=2000,α=0.75,εtarget=2.1611776075000004);

##############################################################
## 5 - Save results
##############################################################

@save "Results/Files_syn/S9CV_ABCE_inference.jld2" P p_accept ε_seq
