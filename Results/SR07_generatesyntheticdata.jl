#=
    SR07 - Generate synthetic data with low r (relative to K)  - HOMOGENEOUS r,K - EXPERIMENTAL CONTROL DATA 
=#
...
CSV.write(filepath_save * "data_cellonly_syn_SR07.csv", data_cellonly_syn) # Export to csv
...
CSV.write(filepath_save * "data_particleonly_syn_SR07.csv", data_particleonly_syn) # Export to csv
...
for i=1:length(T)
    ...
    CSV.write(filepath_save * "data_syn_SR07_" * string(i) * ".csv", data_syn) # Export to csv
end
