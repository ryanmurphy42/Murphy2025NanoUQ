#=
    OPTD_intr - Synthetic data for optimal experimental design study with intermediate r (relative to K)
...
# Prior
prior = Product([
    Uniform(1.0e-7/10,1.0e-7*10),# μr
    Uniform(1.0e-7/10,1.0e-7*10), # σr
    Uniform(5.0,15.0), # μK
    Uniform(0.01,4.0)  # σK
])
