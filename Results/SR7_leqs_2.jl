#=
    SR7_lesq - Synthetic data with intermediate r (relative to K)   - HOMOGENEOUS r,K - EXPERIMENTAL CONTROL DATA
...
@save "Results/Files_syn/Lesq_SR7.jld2" Tplot xopt θfixed median_data_syn