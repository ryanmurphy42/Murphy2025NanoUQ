#=
    SQ5AD - Synthetic data for intermediate r (relative to K) - HOMOGENEOUS r,K - SYNTHETIC CONTROL DATA
...
data_cellonly = CSV.read([filepath_load * "data_syn_SQ05_CELLONLY500V.csv"],DataFrame);
data_particleonly = CSV.read([filepath_load * "data_syn_SQ05_PARTICLEONLY600V.csv"],DataFrame);
