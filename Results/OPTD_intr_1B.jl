#=
    OPTD_intr_1B - Synthetic data for optimal experimental design study with intemediate r (relative to K)
...
@load filepath_save * "OPTD_intr_1A.jld2" observed_data_J
...
@save filepath_save * "OPTD_intr_1B_" * "θsim_save" * "_seed_" * string(HPC_loop_id)  * ".jld2" θsim_save
@save filepath_save * "OPTD_intr_1B_" * "discrepancy" * "_seed_" * string(HPC_loop_id)  * ".jld2" discrepancy
