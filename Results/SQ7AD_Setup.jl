#=
    SQ7AD - Synthetic data for low r (relative to K) - HOMOGENEOUS r,K - SYNTHETIC CONTROL DATA
...
data_cellonly = CSV.read([filepath_load * "data_syn_SQ07_CELLONLY500V.csv"],DataFrame);
data_particleonly = CSV.read([filepath_load * "data_syn_SQ07_PARTICLEONLY600V.csv"],DataFrame);
