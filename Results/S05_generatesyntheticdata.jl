#=
    S05 - Generate synthetic data with intermediate r (relative to K)
=#
...
CSV.write(filepath_save * "data_cellonly_syn_S05.csv", data_cellonly_syn) # Export to csv
...
CSV.write(filepath_save * "data_particleonly_syn_S05.csv", data_particleonly_syn) # Export to csv
...
for i=1:length(T)
    ...
    CSV.write(filepath_save * "data_syn_S05_" * string(i) * ".csv", data_syn) # Export to csv
end
