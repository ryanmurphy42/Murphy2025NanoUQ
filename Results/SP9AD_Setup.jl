#=
    SP9AD - Synthetic data for high r (relative to K) - KNOWN SYNTHETIC CONTROL DATA
...
data_cellonly = CSV.read([filepath_load * "data_syn_SP09_CELLONLY500V.csv"],DataFrame);
data_particleonly = CSV.read([filepath_load * "data_syn_SP09_PARTICLEONLY600V.csv"],DataFrame);
