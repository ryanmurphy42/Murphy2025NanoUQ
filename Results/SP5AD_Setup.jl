#=
    S5AD - Synthetic data for intermediate r (relative to K) - KNOWN SYNTHETIC CONTROL DATA
...
data_cellonly = CSV.read([filepath_load * "data_syn_SP05_CELLONLY500V.csv"],DataFrame);
data_particleonly = CSV.read([filepath_load * "data_syn_SP05_PARTICLEONLY600V.csv"],DataFrame);
