#=
    OPTD_lowr_1A - Synthetic data for optimal experimental design study with low r (relative to K)
...
prior_observed = Product([
    Truncated(Normal(3.86125e-7*0.01,3.86125e-7*0.01/100),0,Inf), # μr
    Truncated(Normal(4.56962e-7*0.01,4.56962e-7*0.01/100),0,Inf), # σr
...
@save filepath_save * "OPTD_lowr_1A.jld2" observed_data_J  θobserved_J
