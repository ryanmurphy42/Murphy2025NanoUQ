#=
    SR9_lesq - Synthetic data with intermediate r (relative to K)   - HOMOGENEOUS r,K - EXPERIMENTAL CONTROL DATA
...
fig_inferred_predictions_ylim= [0,15];
fig_inferred_predictions_yticks = [0,10];
...
@save "Results/Files_syn/Lesq_SR9.jld2" Tplot xopt θfixed median_data_syn