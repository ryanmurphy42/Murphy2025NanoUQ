#=
    SP9_lesq - Synthetic data with high r (relative to K) - KNOWN SYNTHETIC CONTROL DATA
...
Tplot = LinRange(0,25,251);
plot!(fig_raw_median_leastsquares,Tplot,[solve_ode_model_independent(Tplot[i]*3600,xopt,θfixed) for i=1:length(Tplot)],color=:red,lw=3,xticks=[0,12,24],ylims=(-0.5,40.5),ls=:dash)
...
@save "Results/Files_syn/Lesq_SP9.jld2" Tplot xopt θfixed median_data_syn