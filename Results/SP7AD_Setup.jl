#=
    SP7AD - Synthetic data for low r (relative to K) - KNOWN SYNTHETIC CONTROL DATA
...
data_cellonly = CSV.read([filepath_load * "data_syn_SP07_CELLONLY500V.csv"],DataFrame);
data_particleonly = CSV.read([filepath_load * "data_syn_SP07_PARTICLEONLY600V.csv"],DataFrame);
