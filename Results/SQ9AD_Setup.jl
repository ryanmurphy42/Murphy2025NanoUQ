#=
    SQ9AD - Synthetic data for high r (relative to K) - HOMOGENEOUS r,K - SYNTHETIC CONTROL DATA
...
data_cellonly = CSV.read([filepath_load * "data_syn_SQ09_CELLONLY500V.csv"],DataFrame);
data_particleonly = CSV.read([filepath_load * "data_syn_SQ09_PARTICLEONLY600V.csv"],DataFrame);
