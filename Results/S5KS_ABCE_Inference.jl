#=
    S5KS - Synthetic data  with intermediate r (relative to K)
...
Random.seed!(1)
@time P, p_accept, ε_seq  = abc_smc_εtarget(dist,prior,maxsteps=20,n=2000,α=0.75,εtarget=0.051950000000000114);

##############################################################
## 5 - Save results
##############################################################

@save "Results/Files_syn/S5KS_ABCE_inference.jld2" P p_accept ε_seq
