#=
    S01 - Generate synthetic data based on R1
=#
...
μr=2.9636409772399683e-7;
σr=2.929418226130372e-6;
μK=51.16803788865989;
σK=53.2813251769441;
θsyn = [μr,σr,μK,σK];
...
CSV.write(filepath_save * "data_cellonly_syn_S01.csv", data_cellonly_syn) # Export to csv
...
CSV.write(filepath_save * "data_particleonly_syn_S01.csv", data_particleonly_syn) # Export to csv
...
for i=1:length(T)
    ...
    CSV.write(filepath_save * "data_syn_S01_" * string(i) * ".csv", data_syn) # Export to csv
end
