#=
    SQ5_lesq - Synthetic data with intermediate r (relative to K) - HOMOGENEOUS r,K - SYNTHETIC CONTROL DATA
...
@save "Results/Files_syn/Lesq_SQ5.jld2" Tplot xopt θfixed median_data_syn